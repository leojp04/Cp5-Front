  ...
  return (
    <main className="min-h-screen grid place-items-center p-4">
      <div className="w-full max-w-sm">
        ...
        {authError && (
          <div className="mb-4 rounded-md border border-red-500/40 bg-red-950/30 px-3 py-2 text-sm">
            {authError}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label htmlFor="nomeUsuario" className="block text-sm mb-1">
              Nome de usuario
            </label>
            <input
              id="nomeUsuario"
              className={`w-full rounded-md border px-3 py-2 outline-none focus:ring-2 ${
                errors.nomeUsuario
                  ? "border-red-500 bg-red-950/30 focus:ring-red-700"
                  : "border-zinc-800 bg-zinc-900 focus:ring-zinc-700"
              }`}
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/cadastro" className="text-sm underline">
              Criar conta
            </Link>
          </div>
          ...
          <button
            ...
            className="w-full rounded-md border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm font-medium hover:bg-zinc-800 disabled:opacity-60"
          >
